export const news = [
    {
      category: 'Anshumali Karna • New Video',
      title: 'Anshumali Karna Uploaded a new video on YouTube!',
      image:
        'https://yt3.googleusercontent.com/ytc/AIdro_mfHdIYSkyGnzRwyOkViplXZjdziRQDrzkQ7covDGALiwvk=s160-c-k-c0x00ffffff-no-rj',
    },
    {
  ...
  export const whoToFollow = [
    {
      ...
      handle: '@anshumaIi',
      avatar:
        'https://avatars.githubusercontent.com/u/52081717?v=',
    },
    {
      name: 'David Rakosi',
